...
let tipList = ["\" 한번 지나간 단어조합은 되돌릴 수 없어요 \"", "\" 오른쪽 스와이프로 단어조합을 저장할 수 있어요 \"", "\" 왼쪽 스와이프로 새로운 단어조합을 볼 수 있어요 \"", "\" 세개의 단어로 하나의 문장을 만들어 보세요 \"", "\" 아이디어는 작은 단어들로부터 태어날 수 있어요 \"", "\" 단어들은 n마다 업데이트되니 기대해주세요 \""]
